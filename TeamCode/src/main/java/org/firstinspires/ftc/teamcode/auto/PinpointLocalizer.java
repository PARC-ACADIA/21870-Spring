...
public final class PinpointLocalizer implements Localizer {
    public static class Params {
        public double parYTicks = -2672.12463754434; // y position of the parallel encoder (in tick units)
        public double perpXTicks =  -1141.8040517962577; // x position of the perpendicular encoder (in tick units)
    }
